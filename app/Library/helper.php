...
$options['accountsid']='16adbc2032bea9a1c2becb92ad510829';
//填写在开发者控制台首页上的Auth Token
$options['token']='0385979784dd13c3a69e7151511bc154';

//初始化 $options必填
$ucpass = new Ucpaas($options);
// var_dump($ucpass);
$appid = "057f3c83e0274a5a88fcc3ef0ce15d44";	//应用的ID，可在开发者控制台内的短信产品下查看
$templateid = "387963";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
