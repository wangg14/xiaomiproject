    ...
    <div id="mws-navigation"> 
     <ul> 
	  <li> <a href="#"><i class="icon-user"></i>管理员管理</a> 
       <ul class="closed"> 
        <li><a href="/admin_user/create">管理员添加</a></li> 
        <li><a href="/admin_user">管理员列表</a></li> 
      ...
      <li> <a href="#"><i class="icon-user"></i>用户管理</a> 
       ...
       <li> <a href="#"><i class="icon-user"></i>订单管理</a> 
       <ul class="closed"> 
        
        <li><a href="/adminuserss">订单列表</a></li> 
      ...
      <li> <a href="#"><i class="icon-file"></i>公告管理</a> 
       ...
       <ul class="closed"> 
        <li><a href="/carouse/create">图片添加</a></li> 
        <li><a href="/carouse">图片列表</a></li> 
       </ul> </li>
