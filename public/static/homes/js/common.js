...
function addToCart1(goodsId,minnum, parentId)
{
  ...
  if(number<minnum)
  {
    alert('此商品设置了最低订购量为'+minnum+'个，你的购买数量不对!');return;
  }else{
    goods.quick    = quick;
    goods.spec     = spec_arr;
 ...
 * 添加商品到购物车 
 */
function addToCart(goodsId, minnum, parentId)
{
  var goods        = new Object();
  var spec_arr     = new Array();
  var fittings_arr = new Array();
